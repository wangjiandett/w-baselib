...
/**
 * 无限滚动的view pager实现广告，此处只需修改布局展示样式即可，其他逻辑已经实现
 * <p>
...
public class PagersFragment extends BaseFragment {
     ...
     * @param manager     manager
     * @param data        数据源
     * @param containerId 显示滚动广告的容器的id
     */
    ...
    protected void initView(@NotNull @NonNull View view) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                // 通过监听viewpager的滑动来设置页面。如当前有数据0123，则设置页面为301230，
