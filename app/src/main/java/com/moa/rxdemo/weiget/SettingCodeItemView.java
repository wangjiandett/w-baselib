 ...
 */
public class SettingCodeItemView extends RelativeLayout {

    public SettingCodeItemView(Context context) {
        super(context);
        init();
    }

    public SettingCodeItemView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SettingCodeItemView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public SettingCodeItemView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private CountDownTextView mIvCountDown;
    private TextChangeListener mTextChangeListener;

    private void init() {
        View.inflate(getContext(), R.layout.tt_item_setting_code, this);
        ...
        mIvCountDown = (CountDownTextView) findViewById(R.id.tv_check_code);
        ...
        mIvEndIcon.setOnClickListener(v -> mEtText.setText(""));
    }
    ...
    public CountDownTextView getCountDownTv(){
        return mIvCountDown;
    }
