...
public class CircleTextProgressbar extends android.support.v7.widget.AppCompatTextView {
     ...
     * 设置内部圆型到外部圆圈的距离
     *
     * @param inSpace2Out 距离
     */
    public void setInSpace2Out(int inSpace2Out) {
        this.inSpace2Out = inSpace2Out;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(bounds.centerX(), bounds.centerY(), outerRadius - outLineWidth - inSpace2Out, mPaint);
