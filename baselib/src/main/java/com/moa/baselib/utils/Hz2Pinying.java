 ...
 *
 * @author wangjian
 * Created on 2020/8/6 16:01
 */
public class Hz2Pinying {
     ...
     * @return 返回汉字的第一个拼音字符
     */
    public static String oneHzFirstPy(String hanzi) {
        String pinyin = oneHz2Py(hanzi);
     ...
     * @return
     */
    public static String oneHz2PyUpFirst(String hanzi) {
     ...
     * @return 返回拼音
     */
    public static String oneHz2Py(String hanzi) {
        int ascii = oneHz2ASCII(hanzi);
        if (ascii == -1) {
            return null;
        }
        String ret = null;
     ...
     * @return
     */
    public static int oneHz2ASCII(String hanzi) {
        if (hanzi.length() != 1) {
            return -1;
        }
        int ascii = 0;
    ...
    private static int[] pyValue = new int[]{ /*A*/
    ...
    private static String[] pyStr = new String[]{ /*A*/
            "a", "ai", "an", "ang", "ao",  /*B*/
